...
#use factors only for those variables you want to compare categories.
(comp <- compare_variables(check, dirty_data))
#fix locality
#comp$Locality
dirty_data$Locality <- as.character(dirty_data$Locality) #this is not elegant, fix.
dirty_data$Locality <- ifelse(dirty_data$Locality == as.character(comp$Locality$to_fix), as.character(comp$Locality$fixed), dirty_data$Locality)
